...
const ProfileTab = () => {
	...
	return (
		<ScrollView
			...
			contentContainerStyle={{ paddingBlock: 40 }}>
			<View className="relative">
				<View className="items-center mt-10">
					<View className="relative">
						<View className="rounded-full border-primary-DEFAULT">
							<Image
								source={user?.imageUrl}
								style={{ width: 100, height: 100, borderRadius: 999 }}
							/>
						</View>
						<Pressable className="absolute bottom-1 right-1 size-8 bg-primary-DEFAULT rounded-full items-center justify-center border-2 border-surface-DEFAULT">
							<Ionicons name="camera" size={16} color="#352f2d" />
						</Pressable>
					</View>
					...
					<View className="flex-row items-center bg-green-500/20 px-3 py-1.5 rounded-full">
						<View className="bg-green-500 rounded-full size-2 mr-2" />
						<Text className="text-sm font-medium text-green-500 ml-2">
							Online
						</Text>
					</View>
				</View>
